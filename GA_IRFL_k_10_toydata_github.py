...
# toycode of Genetic algorithm to find microbiome discovery in IRFL dataset
...
# data loading
otu_table = pd.read_csv("toydata.csv",index_col = ["patient"])
...
otu_table = pd.read_csv("toydata_IRFL.csv",index_col = ["patient"])
train_otu = otu_table
...
ax3.grid(False)
fig3.savefig("toydata_IRFL_auroc_cv.svg",dpi=300)
...
ax4.grid(False)
fig4.savefig("toydata_IRFL_auroc_cv.svg",dpi=300)
